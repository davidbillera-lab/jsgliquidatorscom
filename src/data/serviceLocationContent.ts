...
export const serviceLocationData: ServiceLocationContent[] = [
  {
    ...
    getHeroSubheadline: (city) => `Professional online estate auctions and custom liquidation plans for ${city} families, with cleanout costs quoted upfront.`,
    ...
    benefits: [
      ...
      "Custom plan with clear sales terms and upfront cleanout pricing when removal is included",
    ...
    getFaq: (city) => [
      { question: `How much does an estate sale cost in ${city}?`, answer: `Pricing depends on the property, the items approved for sale, and the services you choose. We provide a custom plan after a free walkthrough. If a cleanout is included, its quoted cost is paid upfront; sale proceeds may help you recoup that expense but are not guaranteed.` },
  ...
  },
  {
    ...
    getHeroSubheadline: (city) => `Complete ${city} property cleanouts with clear upfront pricing and optional auction or e-commerce sales.`,
    getIntro: (city, county) => `JSG Liquidators' estate cleanout service in ${city} is different from ordinary junk removal. We first evaluate the property and provide an upfront cleanout quote based on the scope of work. With your approval, items with resale potential can be sold through online auction or e-commerce channels. Those proceeds may help you recoup some or all of the cleanout cost, but the result depends on what sells and is not guaranteed.`,
    benefits: [
    ...
    getFaq: (city) => [
      { question: `How much does an estate cleanout cost in ${city}?`, answer: `Estate cleanout costs in ${city} depend on property size, contents, access, labor, and disposal needs. We provide a clear on-site quote, and the cleanout cost is paid upfront. Optional auction or e-commerce proceeds may help you recoup some or all of that expense, but results are not guaranteed.` },
  ...
  },
  {
    ...
    getHeroSubheadline: (city) => `Eco-friendly junk removal for ${city} homes and businesses, quoted upfront with optional resale services.`,
    getIntro: (city, county) => `JSG Liquidators takes a value-first approach to junk removal in ${city}. We evaluate the property, provide a clear upfront removal quote, and identify items that may be better suited for auction or e-commerce sale than disposal. With your approval, those items can be sold separately, and the proceeds may help you recoup part or all of the removal cost without any guarantee.`,
    benefits: [
      "Upfront removal quote based on the actual scope of work",
    ...
    getFaq: (city) => [
      { question: `How much does junk removal cost in ${city}?`, answer: `Junk removal pricing in ${city} depends on volume, accessibility, labor, and disposal needs. We provide a free on-site estimate, and the quoted removal cost is paid upfront. Optional sale proceeds may help you recoup some of that expense but are not guaranteed.` },
  ...
  },
  {
    ...
    getFaq: (city) => [
      { question: `How much does a hoarder cleanout cost in ${city}?`, answer: `Hoarder cleanout pricing in ${city} depends on volume, access, labor, safety conditions, and disposal needs. We provide a clear on-site quote, and the cleanout cost is paid upfront. Approved sale proceeds may later help offset that expense but are not guaranteed.` },
